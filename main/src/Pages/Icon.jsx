...
function Icon() {
  return (
    <>
      <div className='flex justify-center bg-gray-100 mr-10 ml-10 rounded-2xl border '>
...
Home</Link>
<Link to={'/recent'} className='flex m-2 underline font-bold'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
